...
# Sous-réseaux Publics (ALB uniquement)
...
# NAT Gateways (Haute Disponibilité - Un par AZ)
...
# VPC Endpoints (Pour économiser la bande passante NAT Gateway)
